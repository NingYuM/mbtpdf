...
test "string_of_token" {
  inspect!(@pdfgenlex.string_of_token(LexInt(42)), content="Int 42")
  inspect!(@pdfgenlex.string_of_token(LexReal(1.5)), content="Float 1.5")
  inspect!(@pdfgenlex.string_of_token(LexName("foo")), content="Ident foo")
}
```
